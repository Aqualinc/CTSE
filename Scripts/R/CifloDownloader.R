...
DownloadClifloData<-function(BaseDirectory="C:\\Users\\j.dixon\\Desktop\\Climate Data\\Cliflo downloading\\",Agentfile="agents.csv",parameter="rainfall")
  #  DownloadClifloData<-function(BaseDirectory="\\\\some\\directory\\where\\the\\automation\\stuff\\is")
{
  defaultimacro<-readLines(paste0(BaseDirectory,"DefaultClifloDownloaderRad.iim"),-1)
  ...
  for (AgentNo in agents) {
    ...
    defaultimacro[11] <- AgentLine
    defaultimacro[30] <- OutputLine
