#Jonathan Dixon
#Converts data and also removes the
...
rm(list=ls()) # clear memory
  ...
  FromDirectory <- "C:\\Users\\j.dixon\\Desktop\\Deal with duplicates\\Max T\\Raw"

  #specify the directory to write the formatted files to
  ToDirectory <- "C:\\Users\\j.dixon\\Desktop\\Deal with duplicates\\Max T\\Converted"
  
  #directory if non-existent data
  FaultyDirectory <- "C:\\Users\\j.dixon\\Desktop\\Deal with duplicates\\Max T\\"
